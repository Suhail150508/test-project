...
class ClubGallery extends Model
{
    ...
    protected static $logName = 'club_gallery';
    ...
    {
        $log_name = trans(self::$logName . '.club_gallery');
    ...
    {
        return $this->morphOne(File::class, 'fileable')->latest()->where('type', 'club_gallery_image');
    }
